...
<div class="fileupload-buttonbar">
    ...
    <div class="input-group fileupload-img-multi-preview multi-img-details">
    ...
    <div class="help-block image-block"><i class="fa fa-info-circle" aria-hidden="true"></i> 多文件上传，所有的文件图片和文档均可直接上传。</div>
</div>
